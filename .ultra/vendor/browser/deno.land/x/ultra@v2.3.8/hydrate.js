 ...
 */export default function hydrate(container,element,options){requestIdleCallbackUltra(()=>{/**
     * @see https://reactjs.org/docs/react-api.html#starttransition
     */startTransition(()=>{hydrateRoot(container,/*#__PURE__*/h(StrictMode,{children:element}),options);});});}